...
export class AuthorizedRoute extends React.PureComponent<AuthorizedRouteProps, any> {}
...
export class Authorized extends React.PureComponent<AuthorizedProps, any> {
