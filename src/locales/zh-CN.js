export default {
  ...
  'menu.sys.params': '系统参数',
  'menu.sys.administrator': '子管理员',
  'menu.sys.datadic': '数据字典',
  'menu.sysUser': '系统用户',
  'menu.sysUser.factory': '厂家管理',
  'menu.sysUser.merchant': '商家管理',
  'menu.sysUser.user': '用户管理',
  'menu.service': '业务管理',
  'menu.service.feedback': '系统反馈',
  'menu.service.devicedppeal': '设备申诉',
  'menu.service.virtualdevice': '虚拟设备',
  'menu.device': '设备管理',
  'menu.profile': '详情页',
